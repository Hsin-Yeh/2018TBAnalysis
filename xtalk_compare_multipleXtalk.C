void xtalk_compare_multipleXtalk(int Energy)
{
    ...
    for( int iL = 1; iL <= 28; iL++) {
        ...
        E1devE7__3->SetLineColor(800);
        E1devE7__3->SetLineWidth(2);
        E1devE7__3->SetMarkerColor(800);
        ...
        E7devE19__5 = (TH1D *)f_Data.Get(title);
        ...
        E7devE19__3->SetLineColor(800);
        E7devE19__3->SetLineWidth(2);
        E7devE19__3->SetMarkerColor(800);
        ...
        E7devE19__5->SetLineWidth(2);
        E7devE19__5->SetMarkerStyle(20);
        E7devE19__5->SetMarkerSize(0.5);
